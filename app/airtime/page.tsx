    ...
    <div className="mx-auto w-full max-w-2xl space-y-8">
              ...
              >
                <span
                  className={`relative size-16 overflow-hidden rounded-full border-[2.5px] transition-all sm:size-20 ${
                    isSelected
                      ? "border-primary shadow-[0_0_0_4px_rgba(204,107,73,0.15)]"
      ...
      {hasSelection && (
        <section className="hidden md:block">
          <div className="rounded-[28px] bg-[var(--gradient-cta)] p-6 text-white shadow-[0_4px_24px_rgba(204,107,73,0.25)]">
          ...
          >
            <div className="mx-auto flex items-center justify-between gap-4">
              ...
              <Button
                ...
                onClick={buyAirtime}
                disabled={!phone || pinOpen}
                className="h-12 shrink-0 bg-[var(--gradient-cta)] px-6 text-white shadow-[0_4px_16px_rgba(204,107,73,0.3)] hover:opacity-90"
              >
                {service === "airtime" ? "Buy Airtime" : "Buy Data"}
              </Button>
            </div>

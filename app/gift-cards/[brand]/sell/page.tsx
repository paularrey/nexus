  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <aside className="order-first flex flex-col justify-between rounded-[28px] bg-card p-5 shadow-[0_4px_24px_rgb(15_23_42_/_0.06)] ring-1 ring-border md:p-7 lg:order-none lg:sticky lg:top-24">
          <div>

    ...
    <div className="mx-auto w-full max-w-7xl space-y-8">
      ...
      <section className="grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(280px,0.85fr)]">
        <motion.div
          ...
          className="group relative min-h-[250px] overflow-hidden rounded-[28px] bg-[var(--gradient-cta)] p-6 text-white shadow-[0_4px_24px_rgba(196,90,60,0.25)] md:min-h-[300px] md:p-8"
        >
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_15%,rgba(224,122,95,0.4),transparent_30%),radial-gradient(circle_at_20%_100%,rgba(196,90,60,0.5),transparent_50%)]" />

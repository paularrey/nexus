export default function TermsPage() {
  return (
    <article className="mx-auto w-full max-w-3xl space-y-8">
      <header>
        <p className="text-sm font-medium text-primary">Nexus legal</p>
      ...
      <div className="space-y-7 rounded-[28px] border border-border bg-card p-6 leading-7 text-muted-foreground md:p-10">
        <section>
          ...
          <p className="mt-2">
            Nexus is a wallet experience for managing everyday payment tasks. By
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            directed to the Nexus support team.
          </p>
        </section>
      </div>
    </article>

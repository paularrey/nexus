...
<style>body{margin:0;background:#121212;color:#f2f2f2;font:15px Arial,sans-serif}.receipt{width:360px;margin:40px auto;background:#fff;color:#121212;padding:28px;box-shadow:0 12px 35px rgb(0 0 0 / 0.45)}.brand{text-align:center;font-size:24px;font-weight:700;color:#FF5733}.status{text-align:center;margin:24px 0;color:#1f9d63;font-weight:700}.line{border-top:1px dashed #e4e4e4;margin:20px 0}.row{display:flex;justify-content:space-between;gap:16px;margin:13px 0;color:#6b6b6b}.row strong{color:#121212;text-align:right}.total{font-size:22px;font-weight:700;color:#121212}.footer{text-align:center;margin-top:24px;color:#6b6b6b;font-size:12px}@media print{body{background:#fff}.receipt{margin:0;box-shadow:none}}</style></head>
            ...
            {successVisible ? (
              ...
              >
                <motion.div
                  ...
                  className="mx-auto grid size-20 place-items-center rounded-full bg-success text-white shadow-[0_0_35px_rgb(76_175_130_/_0.45)]"
                >

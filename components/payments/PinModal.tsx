...
<style>body{margin:0;background:#F1F0FB;color:#2E2E3A;font:15px Arial,sans-serif}.receipt{width:360px;margin:40px auto;background:#fff;padding:28px;box-shadow:0 12px 35px rgb(46 46 58 / 0.12)}.brand{text-align:center;font-size:24px;font-weight:700;color:#7B7EF0}.status{text-align:center;margin:24px 0;color:#4CAF82;font-weight:700}.line{border-top:1px dashed #E4E3F2;margin:20px 0}.row{display:flex;justify-content:space-between;gap:16px;margin:13px 0;color:#8A8AA3}.row strong{color:#2E2E3A;text-align:right}.total{font-size:22px;font-weight:700;color:#2E2E3A}.footer{text-align:center;margin-top:24px;color:#8A8AA3;font-size:12px}@media print{body{background:#fff}.receipt{margin:0;box-shadow:none}}</style></head>

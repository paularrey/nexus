...
<html><head><meta charset="utf-8"><title>Nexus receipt ${receipt.reference}</title>
...
<body><main class="receipt"><div class="brand">Nexus</div><div class="status">PAYMENT SUCCESSFUL</div><div class="line"></div><div class="row"><span>Service</span><strong>${title}</strong></div><div class="row"><span>Amount</span><strong class="total">${amount ?? "-"}</strong></div><div class="row"><span>Date and time</span><strong>${receipt.timestamp}</strong></div><div class="row"><span>Reference</span><strong>${receipt.reference}</strong></div><div class="row"><span>Status</span><strong>Successful</strong></div><div class="line"></div><div class="footer">This receipt was generated by the Nexus demo.</div></main><script>window.print()</script></body></html>`;
            ...
            {successVisible ? (
              ...
              >
                <motion.div
                  ...
                  className="mx-auto grid size-20 place-items-center rounded-full bg-emerald-400 text-slate-950 shadow-[0_0_35px_rgba(52,211,153,0.55)]"
                >
                ...
                <Button
                  type="button"
                  onClick={finish}
                  className="mt-7 h-11 w-full bg-emerald-400 text-slate-950 hover:bg-emerald-300"
                >
                  Done
                </Button>
              </motion.div>
